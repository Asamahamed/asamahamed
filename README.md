...
I am an **Associate DevOps & Software Engineer** with hands-on experience developing full-stack web applications and provisioning cloud infrastructure. I bridge the gap between development and operations by building highly performant applications in **Java / Spring Boot, Go, and React**, while designing secure, automated deployments on **AWS** using **Terraform, Docker, and Kubernetes**.
